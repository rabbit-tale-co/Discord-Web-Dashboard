...
const editorVariants = cva(
	cn(
		...
		"[&_p]:hyphens-auto [&_span]:hyphens-auto",
		"[&_p]:leading-normal",
		"[&_p]:[overflow-wrap:anywhere] [&_span]:[overflow-wrap:anywhere]",
		"[&_a]:[overflow-wrap:anywhere] [&_a]:break-words",
		"[&_code]:[overflow-wrap:anywhere] [&_code]:break-words",
		"[&_*:has(#)]:[overflow-wrap:anywhere] [&_*:has(#)]:break-words",
		"[&_*:has(@)]:[overflow-wrap:anywhere] [&_*:has(@)]:break-words",
		"[&_*]:[max-width:100%]",
		"[&_p]:mb-1",
	),
